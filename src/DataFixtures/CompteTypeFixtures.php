...
class CompteTypeFixtures extends Fixture implements FixtureGroupInterface
{
	...
	public function load(ObjectManager $manager): void
	{
		...
		$datas = [
			...
			[
				"libelle" => "Compte titres ordinaire",
				"libelleShort" => "CTO",
				"decouvert" => false,
				"tauxInteret" => 0,
				"plancher" => 0,
			...
			[
				"libelle" => "Plan d'épargne en actions",
				"libelleShort" => "PEA",
				"decouvert" => false,
				"tauxInteret" => 0,
				"plancher" => 0,
			...
			[
				"libelle" => "Plan d'épargne retraite",
				"libelleShort" => "PER",
				"decouvert" => false,
				"tauxInteret" => 0,
				"plancher" => 0,
			...
			[
				"libelle" => "Crédit à la consommation",
				"libelleShort" => "CONSO",
				"decouvert" => false,
				"tauxInteret" => 0,
				"plancher" => 0,
